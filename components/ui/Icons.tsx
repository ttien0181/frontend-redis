...
export const LogoIcon: React.FC = () => (
    <svg width="40" height="40" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M48.2,189.3A104,104,0,0,1,189.3,48.2" fill="none" stroke="#a78bfa" strokeLinecap="round" strokeLinejoin="round" strokeWidth="20"/>
        <path d="M66.7,207.8A104,104,0,0,1,207.8,66.7" fill="none" stroke="#818cf8" strokeLinecap="round" strokeLinejoin="round" strokeWidth="20"/>
    </svg>
);
...
export const BuildingOfficeIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0v-4m0 4h5m0-4v-4m0 4v4m0-4h5m-5 4h5m-5-4v-4m5 4v4m0 0v-4" />
  </svg>
);
